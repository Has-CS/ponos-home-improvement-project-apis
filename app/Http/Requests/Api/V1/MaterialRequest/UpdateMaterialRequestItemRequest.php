...
class UpdateMaterialRequestItemRequest extends FormRequest
{
    ...
    {
        return [
            'cost_code_id' => ['sometimes', 'required', 'integer', Rule::exists('cost_codes', 'id')->whereNull('deleted_at')],
    ...
    protected function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            ...
            // Enforce the catalog_item_id-OR-description CHECK against the
            // MERGED post-update state, since either field may be updated alone.
